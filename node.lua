...
local function Markup(config)
    ...
    local H2_FONT_SIZE = node_config.tick_height
...
local function playlist()
    ...
    local function tile_bottom_clock(s, e, now)
        return 0, HEIGHT-node_config.tick_height, 300, HEIGHT
    end

    local function tile_right(s, e, now)
        return WIDTH/2, 100, WIDTH, HEIGHT-node_config.tick_height
    end

    local function tile_left(s, e, now)
        return 0, 100, WIDTH/2, HEIGHT-node_config.tick_height
    end
